...
class LoginPage(BasePage):
    ...
    def _build_left_panel(self, is_dark: bool) -> ft.Container:
        ...
        logo_ctrl = ft.Image(src=logo_path, width=56, height=56, fit=ft.ImageFit.CONTAIN) if os.path.isfile(logo_path) else ft.Icon(ft.Icons.LIGHTBULB, size=42, color="#0AA174")
